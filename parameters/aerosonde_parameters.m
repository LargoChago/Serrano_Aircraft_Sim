...
MAV.u0     = 17;     % initial velocity along body x-axis
MAV.v0     = 1;     % initial velocity along body y-axis
MAV.w0     = 2;     % initial velocity along body z-axis
MAV.phi0   = 0;     % initial roll angle
MAV.theta0 = 0;     % initial pitch angle
MAV.psi0   = 0;     % initial yaw angle
e = Euler2Quaternion(MAV.phi0, MAV.theta0, MAV.psi0);   %  YOU HAVE TO ADD THIS YOURSELF go to wikipedia added
